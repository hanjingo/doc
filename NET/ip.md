...
* [IPv6](#ipv6)
    ...
    - [路由头部](#路由头部)
        ...
        + [inet6_rth_seqments](#inet6_rth_seqments)
        + [inet6_rth_getaddr](#inet6_rth_getaddr)
    - [分片头部](#分片头部)
* [DS字段](#ds字段)
    - [结构](#结构)
* [Internet校验和](#internet校验和)
* [分类寻址](#分类寻址)
* [子网掩码](#子网掩码)
    - [可变长度子网掩码](#可变长度子网掩码)
    - [广播地址](#广播地址)
    - [组播地址](#组播地址)
* [地址转换](#地址转换)
    - [IPv4与IPv6地址转换](#ipv4与ipv6地址转换)
    - [gethostbyname 根据域名查找主机地址](#gethostbyname-根据域名查找主机地址)
    - [gethostbyaddr 根据二进制IP地址查询主机名](#gethostbyaddr-根据二进制ip地址查询主机名)
    - [getservbyname 根据名字查找服务](#getservbyname-根据名字查找服务)
    - [getservbyport 根据端口号和可选协议查找服务](#getservbyport-根据端口号和可选协议查找服务)
    - [getaddrinfo  根据主机名和端口查找地址信息](#getaddrinfo--根据主机名和端口查找地址信息)
    - [gai_strerror 查找非0错误的字符串描述符](#gai_strerror-查找非0错误的字符串描述符)
    - [freeaddrinfo 释放地址空间](#freeaddrinfo-释放地址空间)
    - [getnameinfo 查找主机和服务](#getnameinfo-查找主机和服务)
* [IP选项](#ip选项)
    - [IPv4选项](#ipv4选项)
    - [IPv6选项](#ipv6选项)
        + [步跳选项](#步跳选项)
