...
interposition `/ˌɪntəpə'zɪʃən/` 插入，干涉，插入物
...
particular `/pəˈtɪkjʊlə/` 特别的，特指，详情，细节
...
platter `/'plætə(r)/` 大浅盘，一盘食物，留声机唱片
...
proportional `/prə'pɔːʃənl/` 成比例的，（数学）比例项
...
reentrant `/riː'entrənt/` 凹入的，凹角，重新进入的
