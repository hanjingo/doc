...
handoff `/ˈhændɒf/` 切换（计算机），传球，给球，伸手阻挡对手
...
reciprocal `/rɪ'sɪprəkl/` 互惠的，相互的，互补的，（数）倒数
...
repositories `/rɪ'pɒzətri/` 仓库，容器，储藏室，智囊
