...
<!-- vim-markdown-toc GFM -->
    ...
    * [1如何定位内存问题](#1如何定位内存问题)
    * [2如何定位CPU跑满问题](#2如何定位cpu跑满问题)
    * [3如何定位Core Dump问题](#3如何定位core-dump问题)
        - [3.1Core文件产生原因](#31core文件产生原因)
        - [3.2配置CoreDump](#32配置coredump)
            + [3.2.1开启功能](#321开启功能)
            + [3.2.2文件大小](#322文件大小)
            + [3.2.3命名](#323命名)
            + [3.2.4测试](#324测试)
        - [3.3Core格式](#33core格式)
        - [3.4使用GDB调试CoreDump](#34使用gdb调试coredump)
    * [4如何定位丢包问题](#4如何定位丢包问题)
    * [5如何定位高并发问题](#5如何定位高并发问题)
+ [调试工具](#调试工具)
    * [1GDB](#1gdb)
        - [1.1命令](#11命令)
        - [1.2生成调试文件](#12生成调试文件)
            + [1.2.1CMAKE](#121cmake)
            + [1.2.2MAKE](#122make)
        - [1.3调试可执行文件](#13调试可执行文件)
        - [1.4调试进程](#14调试进程)
        - [1.5调试core文件](#15调试core文件)
    * [2valgrind](#2valgrind)
    * [3WireShark](#3wireshark)
    * [4linux系统日志](#4linux系统日志)
        - [4.1系统日志分类](#41系统日志分类)
        - [4.2日志类型](#42日志类型)
        - [4.3日志级别](#43日志级别)
        - [4.4开启与关闭系统日志](#44开启与关闭系统日志)
            + [4.4.1开启](#441开启)
    * [5linux命令](#5linux命令)
    * [参考](#参考)
