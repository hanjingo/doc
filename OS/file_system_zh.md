...
* [逻辑结构](#逻辑结构)
    - [文件逻辑结构的类型](#文件逻辑结构的类型)
* [顺序文件(Sequential File)](#顺序文件sequential-file)
* [记录寻址](#记录寻址)
    - [索引文件(Index File)](#索引文件index-file)
    - [索引顺序文件(Index Sequential File)](#索引顺序文件index-sequential-file)
* [文件目录](#文件目录)
    - [单级文件目录](#单级文件目录)
    - [两级文件目录](#两级文件目录)
    - [树形结构目录(Tree-Structured Directory)](#树形结构目录tree-structured-directory)
    - [目录查询技术](#目录查询技术)
* [文件共享](#文件共享)
    - [基于有向无循环图实现文件共享](#基于有向无循环图实现文件共享)
    - [利用符号链接实现文件共享](#利用符号链接实现文件共享)
* [文件保护](#文件保护)
* [实现](#实现)
    - [Linux/Unix](#linuxunix)
        + [POSIX文件类型定义](#posix文件类型定义)
        + [不同操作对文件数据结构的影响](#不同操作对文件数据结构的影响)
        + [文件访问权限](#文件访问权限)
