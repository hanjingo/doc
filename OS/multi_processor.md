...
* [多处理机系统的类型](#多处理机系统的类型)
* [多处理机系统的结构](#多处理机系统的结构)
    - [UMA多处理机系统的结构](#uma多处理机系统的结构)
    - [NUMA多处理机系统结构](#numa多处理机系统结构)
* [多处理机操作系统的类型](#多处理机操作系统的类型)
* [进程同步](#进程同步)
    - [集中式与分布式同步方式](#集中式与分布式同步方式)
    - [自旋锁（spin lock）](#自旋锁spin-lock)
    - [读-拷贝-修改锁和二进制指数补偿算法](#读-拷贝-修改锁和二进制指数补偿算法)
    - [二进制指数补偿算法和待锁CPU等待队列机构](#二进制指数补偿算法和待锁cpu等待队列机构)
    - [定序机构](#定序机构)
    - [面包房算法](#面包房算法)
    - [令牌环算法](#令牌环算法)
* [多处理机系统的进程调度](#多处理机系统的进程调度)
    - [评价调度性能的因素](#评价调度性能的因素)
    - [进程分配方式](#进程分配方式)
    - [进程（线程）调度方式](#进程线程调度方式)
