...
$I = (I_m \times (1 - O_g) - W \times P_e) \times H - O_o$
...
假设一台功率为1.4kw的机器1小时收入3块钱，电费0.6元一度，交易所抽水`5%`，不考虑宽带等其他支出，运行一个月的收入如下:

$(3 \times (1 - 0.05) - 1.4 \times 0.6) \times 24 \times 30 = 1447.2$元



## 成本分析

一台矿机器的成本构成 = 一次性投入 + 长期性投入
...
搭建一台：1*显卡的矿机需要：一次性投入：28368元；

按照每天收入3元计算，不考虑人工，维修，宽带等支出，收益曲线如表：
