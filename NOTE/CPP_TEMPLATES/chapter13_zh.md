...
* [13.1 尖括号Hack](#131-尖括号hack)
* [13.2 放松typename的原则](#132-放松typename的原则)
* [13.3 缺省函数模板实参](#133-缺省函数模板实参)
* [13.4 字符串文字和浮点型模板实参](#134-字符串文字和浮点型模板实参)
* [13.5 放松模板的模板参数的匹配](#135-放松模板的模板参数的匹配)
* [13.6 typedef模板](#136-typedef模板)
* [13.7 函数模板的局部特化](#137-函数模板的局部特化)
    - [13.8 typeof运算符](#138-typeof运算符)
* [13.9 命名模板实参](#139-命名模板实参)
* [13.10 静态属性](#1310-静态属性)
* [13.11 客户端的实例化诊断信息](#1311-客户端的实例化诊断信息)
* [13.12 重载类模板](#1312-重载类模板)
* [13.13 List参数](#1313-list参数)
* [13.14 布局控制](#1314-布局控制)
* [13.15 初始化器的演绎](#1315-初始化器的演绎)
* [13.16 函数表达式](#1316-函数表达式)
* [13.17 本章后记](#1317-本章后记)
