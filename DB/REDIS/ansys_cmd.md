English | [中文版](ansys_cmd_zh.md)

# Redis Source Code Analysis - Command Line
...
1. Use a "lazy deletion" policy to check whether the key has expired; if it has, delete it.
2. Look up the key;
	- If found and not expired, return the result;
	- Otherwise return NULL;
3. Update lookup statistics:
	- Non-NULL: increment `stat_keyspace_hits` by 1;
	- NULL: increment `stat_keyspace_misses` by 1;
